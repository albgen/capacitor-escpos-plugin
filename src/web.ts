...
export class ESCPOSPluginWeb extends WebPlugin implements ESCPOSPlugin {
  ...
  async printFormattedText(options: { type: string; id: string; address?: string; port?: string; action?: string; text: string; mmFeedPaper?: String; useEscPosAsterik?: boolean, initializeBeforeSend?: boolean; }): Promise<void> {
